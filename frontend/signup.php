...
<body class="bg-gradient-to-tr from-blue-200 via-white to-purple-200 flex flex-col min-h-screen" >
    ...
    <div class="flex flex-1 items-center justify-center">
        <div class="bg-white/90 p-10 rounded-3xl shadow-2xl w-full max-w-xl border border-gray-100">
            ...
            <form id="signupForm" action="http://localhost:8000/backend/controllers/user_request_handler.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="password" id="confirm_password" name="confirm_password" placeholder="Confirm Password"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400" required>
                    <span id="password-message" class="text-sm text-red-500"></span>
                </div>
